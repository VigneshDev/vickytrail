...
function create()
{
  ...
  myscore = game.add.text(80, 43 , '000' , {font : "5px Arial" , fill : "#eceff1"});
  mylevel = game.add.text(311, 43 , '01' , {font : "5px Arial" , fill : "#eceff1"});
  timer = game.add.text(515, 43, '00:00:00' ,{font : "5px Arial" , fill : "#eceff1"});
}
function createText()
{
